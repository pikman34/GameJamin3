...
{ 
    ...
    { 
        ...
        { 
            ...
            _gridSquares[_gridSquares.Count - 1].GetComponent<GridSquare>().SetImage(square_index % 2 == 0); square_index++; 
            } 
        } 
    } 
    ...
    { 
        ...
        { 
            ...
            { 
                square_gap_number.x++; pos_x_offset += squaresGap; 
            } 
    ...
    { 
        ...
        if (!shapeStorage.placedShapes.Contains(currentShape)) 
        { 
            shapeStorage.placedShapes.Add(currentShape); 
        } 
    } 
}