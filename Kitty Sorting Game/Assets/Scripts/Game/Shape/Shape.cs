...
{ 
    ...
    { 
        ...
        _shapeDraggable = true; _shapeActive = true; 
    } 
    ...
    { 
        ...
        { 
            ...
            { 
                var middleSqaureIndex = (shapeData.rows - 1) / 2; var multiplier = (shapeData.rows - 1) / 2; 
                
                if (row < middleSqaureIndex) 
                { 
                    shiftOnY = moveDistance.y * 1; shiftOnY *= multiplier; 
                } 
            ...
            { 
                ...
                var middleSqaureIndex1 = (shapeData.rows == 2) ? 0 : shapeData.rows - 2; var multiplier = shapeData.rows / 2; 
                ...
                { 
                    ...
                    else if (row > middleSqaureIndex1 && row > middleSqaureIndex2) 
                    { 
                        shiftOnY = moveDistance.y * -1; shiftOnY *= multiplier; 
                    } 
                } 
    ...
    { 
        ...
        { 
            ...
            { 
                var middleSquareIndex = (shapeData.columns - 1) / 2; var multiplier = (shapeData.columns - 1) / 2; 
                
                if (column < middleSquareIndex) 
                { 
                    shiftOnX = moveDistance.x * -1; shiftOnX *= multiplier; 
                } 
            ...
            { 
                ...
                var middleSquareIndex1 = (shapeData.columns == 2) ? 0 : shapeData.columns - 1; var multiplier = shapeData.columns / 2; 
    ...
    { 
        ...
        { 
            ...
            if (shapeStorage.placedShapes.Contains(this)) 
            { 
                shapeStorage.placedShapes.Remove(this); 
            } 
        } 
        foreach (var gridSquare in _occupiedSquares) 
        { 
